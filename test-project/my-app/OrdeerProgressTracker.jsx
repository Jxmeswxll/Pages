...
// Simple className combiner to replace @/lib/utils
const cn = (...classes) => {
...
100;
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-6 max-w-md mx-auto">
      <h2 className="text-xl font-bold mb-4 text-center">Order 
Tracking</h2>
      
      {/* Speedometer-like Progress Container */}
      <div className="relative w-full h-20 bg-gray-100 rounded-full 
          ...
          {stages.map((stage, index) => {
            ...
            return (
              <div 
                ...
                className={cn(
                  "z-10 w-12 h-12 rounded-full flex items-center 
...
font-semibold">{currentStage.key.toUpperCase()} Stage</h3>
          </div>
          <p className="text-gray-600">
            {(() => {
              switch(currentStage.key) {
                case 'ordered':
                  return "Your order has been received and is waiting to 
be picked from our inventory.";
                case 'picked':
                  return "Items have been selected and are ready for the 
next stage of processing.";
                case 'build':
                  return "Your order is currently being assembled or 
manufactured.";
                case 'test':
                  return "Quality checks and final production steps are 
being performed.";
                case 'packed':
                  return "All items have been carefully packed and 
prepared for shipping.";
                case 'sent':
                  return "Your order is on its way! Tracking information 
has been generated.";
                default:
