document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayMobileSingleView(recs) {
        ...
        function updateActive(index) {
            ...
            pillsContainer.querySelectorAll('.mobile-pill').forEach((p, i) => p.classList.toggle('active', i == index));
            dotsContainer.querySelectorAll('.pagination-dot').forEach((d, i) => d.classList.toggle('active', i == index));
        }
        ...
        productView.addEventListener('touchstart', e => {
            touchstartX = e.changedTouches[0].screenX;
        }, { passive: true });

        productView.addEventListener('touchend', e => {
